		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getUseIncludeAccess().getAlternatives_2_1_0(), "rule__UseInclude__Alternatives_2_1_0");
					...
					put(grammarAccess.getQUALIFIED_IDAccess().getAlternatives_1_0(), "rule__QUALIFIED_ID__Alternatives_1_0");
					...
					put(grammarAccess.getUseIncludeAccess().getPragmaAssignment_2_1_0_0(), "rule__UseInclude__PragmaAssignment_2_1_0_0");
					put(grammarAccess.getUseIncludeAccess().getPackageAssignment_2_1_0_1(), "rule__UseInclude__PackageAssignment_2_1_0_1");
					...
					put(grammarAccess.getSubStatementAccess().getBlockAssignment_4_0(), "rule__SubStatement__BlockAssignment_4_0");
