...
public class InternalPerlLexer extends Lexer {
    ...
    public final void mT__42() throws RecognitionException {
        try {
            int _type = T__42;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPerl.g:39:7: ( 'sub' )
            // InternalPerl.g:39:9: 'sub'
            {
            match("sub"); 
    ...
    public final void mT__48() throws RecognitionException {
        try {
            int _type = T__48;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPerl.g:45:7: ( 'if' )
            // InternalPerl.g:45:9: 'if'
            {
            match("if"); 
    ...
    public final void mT__50() throws RecognitionException {
        try {
            int _type = T__50;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPerl.g:47:7: ( 'my' )
            // InternalPerl.g:47:9: 'my'
            {
            match("my"); 
    ...
    public final void mT__51() throws RecognitionException {
        try {
            int _type = T__51;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPerl.g:48:7: ( 'our' )
            // InternalPerl.g:48:9: 'our'
            {
            match("our"); 
    ...
    public final void mT__52() throws RecognitionException {
        try {
            int _type = T__52;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPerl.g:49:7: ( 'local' )
            // InternalPerl.g:49:9: 'local'
            {
            match("local"); 
    ...
    public final void mRULE_VAR_START() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPerl.g:2224:16: ( ( '@' | '$' | '%' ) ( '@' | '$' | '%' | '*' | '#' )* )
            // InternalPerl.g:2224:18: ( '@' | '$' | '%' ) ( '@' | '$' | '%' | '*' | '#' )*
            {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPerl.g:2226:9: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalPerl.g:2226:11: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            ...
            // InternalPerl.g:2226:35: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPerl.g:2228:10: ( '1' .. '9' ( '0' .. '9' | '_' )* )
            // InternalPerl.g:2228:12: '1' .. '9' ( '0' .. '9' | '_' )*
            {
            matchRange('1','9'); 
            // InternalPerl.g:2228:21: ( '0' .. '9' | '_' )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_OCT() throws RecognitionException {
        try {
            int _type = RULE_OCT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPerl.g:2230:10: ( '0' ( '0' .. '7' | '_' )+ )
            // InternalPerl.g:2230:12: '0' ( '0' .. '7' | '_' )+
            {
            match('0'); 
            // InternalPerl.g:2230:16: ( '0' .. '7' | '_' )+
            int cnt4=0;
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_HEX() throws RecognitionException {
        try {
            int _type = RULE_HEX;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPerl.g:2232:10: ( ( '0x' | '0X' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' | '_' )+ )
            // InternalPerl.g:2232:12: ( '0x' | '0X' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' | '_' )+
            {
            // InternalPerl.g:2232:12: ( '0x' | '0X' )
            int alt5=2;
            ...
            // InternalPerl.g:2232:24: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' | '_' )+
            int cnt6=0;
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_BIN() throws RecognitionException {
        try {
            int _type = RULE_BIN;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPerl.g:2234:10: ( '0b' ( '0' .. '1' | '_' )+ )
            // InternalPerl.g:2234:12: '0b' ( '0' .. '1' | '_' )+
            {
            match("0b"); 

            // InternalPerl.g:2234:17: ( '0' .. '1' | '_' )+
            int cnt7=0;
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPerl.g:2236:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalPerl.g:2236:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalPerl.g:2236:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalPerl.g:2236:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalPerl.g:2236:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
                    ...
                    break;
                case 2 :
                    // InternalPerl.g:2236:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalPerl.g:2236:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop9:
                    do {
                        int alt9=3;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPerl.g:2238:17: ( '#' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalPerl.g:2238:19: '#' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match('#'); 
            // InternalPerl.g:2238:23: (~ ( ( '\\n' | '\\r' ) ) )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPerl.g:2240:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalPerl.g:2240:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalPerl.g:2240:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt14=0;
            loop14:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPerl.g:2242:16: ( . )
            // InternalPerl.g:2242:18: .
            {
            matchAny(); 
    ...
    static final String DFA15_eotS =
        "\1\uffff\1\47\1\52\1\55\1\60\1\62\1\64\1\67\1\71\2\44\1\75\2\100\1\44\1\100\5\uffff\6\100\1\44\3\uffff\3\44\15\uffff\1\130\16\uffff\1\131\1\100\1\uffff\1\133\1\uffff\1\100\5\uffff\1\135\1\136\4\100\13\uffff\1\100\1\uffff\1\144\2\uffff\1\145\3\100\1\151\2\uffff\3\100\1\uffff\1\155\1\156\1\100\2\uffff\1\160\1\uffff";
    static final String DFA15_eofS =
        "\161\uffff";
    static final String DFA15_minS =
        "\1\0\1\75\1\53\1\55\1\52\1\75\1\43\1\76\1\75\1\174\1\46\1\75\1\154\1\145\1\72\1\165\5\uffff\1\146\1\171\1\165\1\157\1\156\1\145\1\72\3\uffff\1\60\2\0\15\uffff\1\75\16\uffff\1\60\1\163\1\uffff\1\60\1\uffff\1\142\5\uffff\2\60\1\162\1\143\1\144\1\164\13\uffff\1\145\1\uffff\1\60\2\uffff\1\60\1\141\1\145\1\165\1\60\2\uffff\1\154\1\146\1\162\1\uffff\2\60\1\156\2\uffff\1\60\1\uffff";
    static final String DFA15_maxS =
        "\1\uffff\1\76\4\75\1\100\1\76\1\75\1\174\1\46\1\75\1\161\1\145\1\72\1\165\5\uffff\1\146\1\171\1\165\1\157\1\156\1\145\1\72\3\uffff\1\170\2\uffff\15\uffff\1\75\16\uffff\1\172\1\163\1\uffff\1\172\1\uffff\1\142\5\uffff\2\172\1\162\1\143\1\144\1\164\13\uffff\1\145\1\uffff\1\172\2\uffff\1\172\1\141\1\145\1\165\1\172\2\uffff\1\154\1\146\1\162\1\uffff\2\172\1\156\2\uffff\1\172\1\uffff";
    static final String DFA15_acceptS =
        "\20\uffff\1\36\1\37\1\40\1\41\1\42\7\uffff\1\53\1\54\1\55\3\uffff\1\62\1\63\1\64\1\15\1\21\1\1\1\2\1\33\1\24\1\3\1\34\1\25\1\4\1\uffff\1\26\1\5\1\30\1\6\1\31\1\53\1\22\1\10\1\12\1\11\1\13\1\14\1\16\1\32\2\uffff\1\54\1\uffff\1\23\1\uffff\1\36\1\37\1\40\1\41\1\42\6\uffff\1\52\1\55\1\57\1\60\1\56\1\61\1\62\1\63\1\7\1\27\1\17\1\uffff\1\20\1\uffff\1\43\1\45\5\uffff\1\35\1\46\3\uffff\1\44\3\uffff\1\47\1\50\1\uffff\1\51";
    static final String DFA15_specialS =
        "\1\0\37\uffff\1\2\1\1\117\uffff}>";
    static final String[] DFA15_transitionS = {
            "\11\44\2\43\2\44\1\43\22\44\1\43\1\13\1\40\1\42\1\34\1\6\1\12\1\41\1\23\1\24\1\4\1\2\1\44\1\3\1\44\1\5\1\37\11\36\1\33\1\22\1\7\1\1\1\10\1\16\1\34\32\35\4\44\1\35\1\44\4\35\1\14\3\35\1\25\2\35\1\30\1\26\1\15\1\27\2\35\1\32\1\17\1\35\1\31\5\35\1\20\1\11\1\21\uff82\44",
            "\1\45\1\46",
            "\1\51\21\uffff\1\50",
            "\1\54\17\uffff\1\53",
            "\1\57\22\uffff\1\56",
            "\1\61",
            "\3\65\4\uffff\1\65\22\uffff\1\63\2\uffff\1\65",
            "\1\66",
            "\1\70",
            "\1\72",
            "\1\73",
