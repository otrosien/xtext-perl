...
public class InternalPerlParser extends AbstractInternalAntlrParser {
    ...
    public static final int RULE_READLINE_QUOTE=14;
    ...
    public static final int RULE_COMMAND_QUOTE_LIKE=12;
    ...
    public static final int RULE_BIN=16;
    public static final int RULE_INTERPOLATE=6;
    ...
    public static final int RULE_WORDS_QUOTE_LIKE=11;
    public static final int T__169=169;
    public static final int RULE_REGEX_QUOTE=13;
    ...
    public static final int RULE_BACKTICK_STRING=10;
    ...
    public final EObject rulePerlDocument() throws RecognitionException {
        ...
        try {
            ...
            do {
                ...
                if ( ((LA1_0>=RULE_POD && LA1_0<=RULE_INT)||(LA1_0>=22 && LA1_0<=334)) ) {
                    alt1=1;
                }
    ...
    // InternalPerl.g:116:1: ruleElement returns [EObject current=null] : this_Token_0= ruleToken ;
    public final EObject ruleElement() throws RecognitionException {
        ...
        try {
            // InternalPerl.g:122:2: (this_Token_0= ruleToken )
            // InternalPerl.g:123:2: this_Token_0= ruleToken
            {
    ...
    // InternalPerl.g:134:1: entryRuleToken returns [EObject current=null] : iv_ruleToken= ruleToken EOF ;
    public final EObject entryRuleToken() throws RecognitionException {
        ...
        try {
            // InternalPerl.g:134:46: (iv_ruleToken= ruleToken EOF )
            // InternalPerl.g:135:2: iv_ruleToken= ruleToken EOF
            {
    ...
    // InternalPerl.g:141:1: ruleToken returns [EObject current=null] : ( ( () ( (lv_content_1_0= RULE_POD ) ) ) | ( () ( (lv_content_3_0= ruleNumber ) ) ) | ( () ( (lv_content_5_0= ruleWord ) ) ) | this_QuoteLikeToken_6= ruleQuoteLikeToken | ( () ( (lv_content_8_0= ruleFileTestOperator ) ) ) | ( () ( (lv_content_10_0= ruleOperator ) ) ) | ( () ( (lv_content_12_0= RULE_STRING ) ) ) | ( () ( (lv_content_14_0= RULE_INTERPOLATE ) ) ) | ( () ( (lv_content_16_0= RULE_LITERAL ) ) ) | ( () ( (lv_content_18_0= RULE_DATA ) ) ) | ( () ( (lv_content_20_0= RULE_END ) ) ) ) ;
    public final EObject ruleToken() throws RecognitionException {
        ...
        EObject this_QuoteLikeToken_6 = null;
        ...
        try {
            // InternalPerl.g:147:2: ( ( ( () ( (lv_content_1_0= RULE_POD ) ) ) | ( () ( (lv_content_3_0= ruleNumber ) ) ) | ( () ( (lv_content_5_0= ruleWord ) ) ) | this_QuoteLikeToken_6= ruleQuoteLikeToken | ( () ( (lv_content_8_0= ruleFileTestOperator ) ) ) | ( () ( (lv_content_10_0= ruleOperator ) ) ) | ( () ( (lv_content_12_0= RULE_STRING ) ) ) | ( () ( (lv_content_14_0= RULE_INTERPOLATE ) ) ) | ( () ( (lv_content_16_0= RULE_LITERAL ) ) ) | ( () ( (lv_content_18_0= RULE_DATA ) ) ) | ( () ( (lv_content_20_0= RULE_END ) ) ) ) )
            // InternalPerl.g:148:2: ( ( () ( (lv_content_1_0= RULE_POD ) ) ) | ( () ( (lv_content_3_0= ruleNumber ) ) ) | ( () ( (lv_content_5_0= ruleWord ) ) ) | this_QuoteLikeToken_6= ruleQuoteLikeToken | ( () ( (lv_content_8_0= ruleFileTestOperator ) ) ) | ( () ( (lv_content_10_0= ruleOperator ) ) ) | ( () ( (lv_content_12_0= RULE_STRING ) ) ) | ( () ( (lv_content_14_0= RULE_INTERPOLATE ) ) ) | ( () ( (lv_content_16_0= RULE_LITERAL ) ) ) | ( () ( (lv_content_18_0= RULE_DATA ) ) ) | ( () ( (lv_content_20_0= RULE_END ) ) ) )
            {
            // InternalPerl.g:148:2: ( ( () ( (lv_content_1_0= RULE_POD ) ) ) | ( () ( (lv_content_3_0= ruleNumber ) ) ) | ( () ( (lv_content_5_0= ruleWord ) ) ) | this_QuoteLikeToken_6= ruleQuoteLikeToken | ( () ( (lv_content_8_0= ruleFileTestOperator ) ) ) | ( () ( (lv_content_10_0= ruleOperator ) ) ) | ( () ( (lv_content_12_0= RULE_STRING ) ) ) | ( () ( (lv_content_14_0= RULE_INTERPOLATE ) ) ) | ( () ( (lv_content_16_0= RULE_LITERAL ) ) ) | ( () ( (lv_content_18_0= RULE_DATA ) ) ) | ( () ( (lv_content_20_0= RULE_END ) ) ) )
            int alt2=11;
            ...
            else if ( ((LA2_0>=22 && LA2_0<=243)) ) {
                alt2=3;
            }
            else if ( ((LA2_0>=RULE_BACKTICK_STRING && LA2_0<=RULE_READLINE_QUOTE)) ) {
                alt2=4;
            }
            else if ( ((LA2_0>=308 && LA2_0<=334)) ) {
                alt2=5;
            }
            else if ( ((LA2_0>=244 && LA2_0<=307)) ) {
                alt2=6;
            }
            ...
            switch (alt2) {
                case 1 :
                    // InternalPerl.g:149:3: ( () ( (lv_content_1_0= RULE_POD ) ) )
                    {
                    // InternalPerl.g:149:3: ( () ( (lv_content_1_0= RULE_POD ) ) )
                    // InternalPerl.g:150:4: () ( (lv_content_1_0= RULE_POD ) )
                    {
                    // InternalPerl.g:150:4: ()
                    // InternalPerl.g:151:5: 
                    {
                    ...
                    // InternalPerl.g:157:4: ( (lv_content_1_0= RULE_POD ) )
                    // InternalPerl.g:158:5: (lv_content_1_0= RULE_POD )
                    {
                    // InternalPerl.g:158:5: (lv_content_1_0= RULE_POD )
                    // InternalPerl.g:159:6: lv_content_1_0= RULE_POD
                    {
                    ...
                    break;
                case 2 :
                    // InternalPerl.g:177:3: ( () ( (lv_content_3_0= ruleNumber ) ) )
                    {
                    // InternalPerl.g:177:3: ( () ( (lv_content_3_0= ruleNumber ) ) )
                    // InternalPerl.g:178:4: () ( (lv_content_3_0= ruleNumber ) )
                    {
                    // InternalPerl.g:178:4: ()
                    // InternalPerl.g:179:5: 
                    {
                    ...
                    // InternalPerl.g:185:4: ( (lv_content_3_0= ruleNumber ) )
                    // InternalPerl.g:186:5: (lv_content_3_0= ruleNumber )
                    {
                    // InternalPerl.g:186:5: (lv_content_3_0= ruleNumber )
                    // InternalPerl.g:187:6: lv_content_3_0= ruleNumber
                    {
                    ...
                    break;
                case 3 :
                    // InternalPerl.g:206:3: ( () ( (lv_content_5_0= ruleWord ) ) )
                    {
                    // InternalPerl.g:206:3: ( () ( (lv_content_5_0= ruleWord ) ) )
                    // InternalPerl.g:207:4: () ( (lv_content_5_0= ruleWord ) )
                    {
                    // InternalPerl.g:207:4: ()
                    // InternalPerl.g:208:5: 
                    {
                    ...
                    // InternalPerl.g:214:4: ( (lv_content_5_0= ruleWord ) )
                    // InternalPerl.g:215:5: (lv_content_5_0= ruleWord )
                    {
                    // InternalPerl.g:215:5: (lv_content_5_0= ruleWord )
                    // InternalPerl.g:216:6: lv_content_5_0= ruleWord
                    {
                    ...
                    break;
                case 4 :
                    // InternalPerl.g:235:3: this_QuoteLikeToken_6= ruleQuoteLikeToken
                    {
                    ...
                    break;
                case 5 :
                    // InternalPerl.g:244:3: ( () ( (lv_content_8_0= ruleFileTestOperator ) ) )
                    {
                    // InternalPerl.g:244:3: ( () ( (lv_content_8_0= ruleFileTestOperator ) ) )
                    // InternalPerl.g:245:4: () ( (lv_content_8_0= ruleFileTestOperator ) )
                    {
                    // InternalPerl.g:245:4: ()
                    // InternalPerl.g:246:5: 
                    {
                    ...
                    // InternalPerl.g:252:4: ( (lv_content_8_0= ruleFileTestOperator ) )
                    // InternalPerl.g:253:5: (lv_content_8_0= ruleFileTestOperator )
                    {
                    // InternalPerl.g:253:5: (lv_content_8_0= ruleFileTestOperator )
                    // InternalPerl.g:254:6: lv_content_8_0= ruleFileTestOperator
                    {
                    ...
                    break;
                case 6 :
                    // InternalPerl.g:273:3: ( () ( (lv_content_10_0= ruleOperator ) ) )
                    {
                    // InternalPerl.g:273:3: ( () ( (lv_content_10_0= ruleOperator ) ) )
                    // InternalPerl.g:274:4: () ( (lv_content_10_0= ruleOperator ) )
                    {
                    // InternalPerl.g:274:4: ()
                    // InternalPerl.g:275:5: 
                    {
                    ...
                    // InternalPerl.g:281:4: ( (lv_content_10_0= ruleOperator ) )
                    // InternalPerl.g:282:5: (lv_content_10_0= ruleOperator )
                    {
                    // InternalPerl.g:282:5: (lv_content_10_0= ruleOperator )
                    // InternalPerl.g:283:6: lv_content_10_0= ruleOperator
                    {
                    ...
                    break;
                case 7 :
                    // InternalPerl.g:302:3: ( () ( (lv_content_12_0= RULE_STRING ) ) )
                    {
                    // InternalPerl.g:302:3: ( () ( (lv_content_12_0= RULE_STRING ) ) )
                    // InternalPerl.g:303:4: () ( (lv_content_12_0= RULE_STRING ) )
                    {
                    // InternalPerl.g:303:4: ()
                    // InternalPerl.g:304:5: 
                    {
                    ...
                    // InternalPerl.g:310:4: ( (lv_content_12_0= RULE_STRING ) )
                    // InternalPerl.g:311:5: (lv_content_12_0= RULE_STRING )
                    {
                    // InternalPerl.g:311:5: (lv_content_12_0= RULE_STRING )
                    // InternalPerl.g:312:6: lv_content_12_0= RULE_STRING
                    {
                    lv_content_12_0=(Token)match(input,RULE_STRING,FOLLOW_2); 
                    ...
                    break;
                case 8 :
                    // InternalPerl.g:330:3: ( () ( (lv_content_14_0= RULE_INTERPOLATE ) ) )
                    {
                    // InternalPerl.g:330:3: ( () ( (lv_content_14_0= RULE_INTERPOLATE ) ) )
                    // InternalPerl.g:331:4: () ( (lv_content_14_0= RULE_INTERPOLATE ) )
                    {
                    // InternalPerl.g:331:4: ()
                    // InternalPerl.g:332:5: 
                    {
                    ...
                    // InternalPerl.g:338:4: ( (lv_content_14_0= RULE_INTERPOLATE ) )
                    // InternalPerl.g:339:5: (lv_content_14_0= RULE_INTERPOLATE )
                    {
                    // InternalPerl.g:339:5: (lv_content_14_0= RULE_INTERPOLATE )
                    // InternalPerl.g:340:6: lv_content_14_0= RULE_INTERPOLATE
                    {
                    lv_content_14_0=(Token)match(input,RULE_INTERPOLATE,FOLLOW_2); 
                    ...
                    break;
                case 9 :
                    // InternalPerl.g:358:3: ( () ( (lv_content_16_0= RULE_LITERAL ) ) )
                    {
                    // InternalPerl.g:358:3: ( () ( (lv_content_16_0= RULE_LITERAL ) ) )
                    // InternalPerl.g:359:4: () ( (lv_content_16_0= RULE_LITERAL ) )
                    {
                    // InternalPerl.g:359:4: ()
                    // InternalPerl.g:360:5: 
                    {
                    ...
                    // InternalPerl.g:366:4: ( (lv_content_16_0= RULE_LITERAL ) )
                    // InternalPerl.g:367:5: (lv_content_16_0= RULE_LITERAL )
                    {
                    // InternalPerl.g:367:5: (lv_content_16_0= RULE_LITERAL )
                    // InternalPerl.g:368:6: lv_content_16_0= RULE_LITERAL
                    {
                    lv_content_16_0=(Token)match(input,RULE_LITERAL,FOLLOW_2); 
                    ...
                    break;
                case 10 :
                    // InternalPerl.g:386:3: ( () ( (lv_content_18_0= RULE_DATA ) ) )
                    {
                    // InternalPerl.g:386:3: ( () ( (lv_content_18_0= RULE_DATA ) ) )
                    // InternalPerl.g:387:4: () ( (lv_content_18_0= RULE_DATA ) )
                    {
                    // InternalPerl.g:387:4: ()
                    // InternalPerl.g:388:5: 
                    {
                    ...
                    // InternalPerl.g:394:4: ( (lv_content_18_0= RULE_DATA ) )
                    // InternalPerl.g:395:5: (lv_content_18_0= RULE_DATA )
                    {
                    // InternalPerl.g:395:5: (lv_content_18_0= RULE_DATA )
                    // InternalPerl.g:396:6: lv_content_18_0= RULE_DATA
                    {
                    lv_content_18_0=(Token)match(input,RULE_DATA,FOLLOW_2); 
                    ...
                    break;
                case 11 :
                    // InternalPerl.g:414:3: ( () ( (lv_content_20_0= RULE_END ) ) )
                    {
                    // InternalPerl.g:414:3: ( () ( (lv_content_20_0= RULE_END ) ) )
                    // InternalPerl.g:415:4: () ( (lv_content_20_0= RULE_END ) )
                    {
                    // InternalPerl.g:415:4: ()
                    // InternalPerl.g:416:5: 
                    {
                    ...
                    // InternalPerl.g:422:4: ( (lv_content_20_0= RULE_END ) )
                    // InternalPerl.g:423:5: (lv_content_20_0= RULE_END )
                    {
                    // InternalPerl.g:423:5: (lv_content_20_0= RULE_END )
                    // InternalPerl.g:424:6: lv_content_20_0= RULE_END
                    {
                    lv_content_20_0=(Token)match(input,RULE_END,FOLLOW_2); 
    ...
    // InternalPerl.g:445:1: entryRuleQuoteLikeToken returns [EObject current=null] : iv_ruleQuoteLikeToken= ruleQuoteLikeToken EOF ;
    public final EObject entryRuleQuoteLikeToken() throws RecognitionException {
        ...
        try {
            // InternalPerl.g:445:55: (iv_ruleQuoteLikeToken= ruleQuoteLikeToken EOF )
            // InternalPerl.g:446:2: iv_ruleQuoteLikeToken= ruleQuoteLikeToken EOF
            {
    ...
    // InternalPerl.g:452:1: ruleQuoteLikeToken returns [EObject current=null] : ( ( () ( (lv_content_1_0= RULE_BACKTICK_STRING ) ) ) | ( () ( (lv_content_3_0= RULE_WORDS_QUOTE_LIKE ) ) ) | ( () ( (lv_content_5_0= RULE_COMMAND_QUOTE_LIKE ) ) ) | ( () ( (lv_content_7_0= RULE_REGEX_QUOTE ) ) ) | ( () ( (lv_content_9_0= RULE_READLINE_QUOTE ) ) ) ) ;
    public final EObject ruleQuoteLikeToken() throws RecognitionException {
        ...
        try {
            // InternalPerl.g:458:2: ( ( ( () ( (lv_content_1_0= RULE_BACKTICK_STRING ) ) ) | ( () ( (lv_content_3_0= RULE_WORDS_QUOTE_LIKE ) ) ) | ( () ( (lv_content_5_0= RULE_COMMAND_QUOTE_LIKE ) ) ) | ( () ( (lv_content_7_0= RULE_REGEX_QUOTE ) ) ) | ( () ( (lv_content_9_0= RULE_READLINE_QUOTE ) ) ) ) )
            // InternalPerl.g:459:2: ( ( () ( (lv_content_1_0= RULE_BACKTICK_STRING ) ) ) | ( () ( (lv_content_3_0= RULE_WORDS_QUOTE_LIKE ) ) ) | ( () ( (lv_content_5_0= RULE_COMMAND_QUOTE_LIKE ) ) ) | ( () ( (lv_content_7_0= RULE_REGEX_QUOTE ) ) ) | ( () ( (lv_content_9_0= RULE_READLINE_QUOTE ) ) ) )
            {
            // InternalPerl.g:459:2: ( ( () ( (lv_content_1_0= RULE_BACKTICK_STRING ) ) ) | ( () ( (lv_content_3_0= RULE_WORDS_QUOTE_LIKE ) ) ) | ( () ( (lv_content_5_0= RULE_COMMAND_QUOTE_LIKE ) ) ) | ( () ( (lv_content_7_0= RULE_REGEX_QUOTE ) ) ) | ( () ( (lv_content_9_0= RULE_READLINE_QUOTE ) ) ) )
            int alt3=5;
            switch ( input.LA(1) ) {
            ...
            switch (alt3) {
                case 1 :
                    // InternalPerl.g:460:3: ( () ( (lv_content_1_0= RULE_BACKTICK_STRING ) ) )
                    {
                    // InternalPerl.g:460:3: ( () ( (lv_content_1_0= RULE_BACKTICK_STRING ) ) )
                    // InternalPerl.g:461:4: () ( (lv_content_1_0= RULE_BACKTICK_STRING ) )
                    {
                    ...
                    // InternalPerl.g:468:4: ( (lv_content_1_0= RULE_BACKTICK_STRING ) )
                    // InternalPerl.g:469:5: (lv_content_1_0= RULE_BACKTICK_STRING )
                    {
                    // InternalPerl.g:469:5: (lv_content_1_0= RULE_BACKTICK_STRING )
                    // InternalPerl.g:470:6: lv_content_1_0= RULE_BACKTICK_STRING
                    {
                    ...
                    break;
                case 2 :
                    // InternalPerl.g:488:3: ( () ( (lv_content_3_0= RULE_WORDS_QUOTE_LIKE ) ) )
                    {
                    // InternalPerl.g:488:3: ( () ( (lv_content_3_0= RULE_WORDS_QUOTE_LIKE ) ) )
                    // InternalPerl.g:489:4: () ( (lv_content_3_0= RULE_WORDS_QUOTE_LIKE ) )
                    {
                    // InternalPerl.g:489:4: ()
                    // InternalPerl.g:490:5: 
                    {
                    ...
                    // InternalPerl.g:496:4: ( (lv_content_3_0= RULE_WORDS_QUOTE_LIKE ) )
                    // InternalPerl.g:497:5: (lv_content_3_0= RULE_WORDS_QUOTE_LIKE )
                    {
                    // InternalPerl.g:497:5: (lv_content_3_0= RULE_WORDS_QUOTE_LIKE )
                    // InternalPerl.g:498:6: lv_content_3_0= RULE_WORDS_QUOTE_LIKE
                    {
                    ...
                    break;
                case 3 :
                    // InternalPerl.g:516:3: ( () ( (lv_content_5_0= RULE_COMMAND_QUOTE_LIKE ) ) )
                    {
                    // InternalPerl.g:516:3: ( () ( (lv_content_5_0= RULE_COMMAND_QUOTE_LIKE ) ) )
                    // InternalPerl.g:517:4: () ( (lv_content_5_0= RULE_COMMAND_QUOTE_LIKE ) )
                    {
                    // InternalPerl.g:517:4: ()
                    // InternalPerl.g:518:5: 
                    {
                    ...
                    // InternalPerl.g:524:4: ( (lv_content_5_0= RULE_COMMAND_QUOTE_LIKE ) )
                    // InternalPerl.g:525:5: (lv_content_5_0= RULE_COMMAND_QUOTE_LIKE )
                    {
                    // InternalPerl.g:525:5: (lv_content_5_0= RULE_COMMAND_QUOTE_LIKE )
                    // InternalPerl.g:526:6: lv_content_5_0= RULE_COMMAND_QUOTE_LIKE
                    {
                    ...
                    break;
                case 4 :
                    // InternalPerl.g:544:3: ( () ( (lv_content_7_0= RULE_REGEX_QUOTE ) ) )
                    {
                    // InternalPerl.g:544:3: ( () ( (lv_content_7_0= RULE_REGEX_QUOTE ) ) )
                    // InternalPerl.g:545:4: () ( (lv_content_7_0= RULE_REGEX_QUOTE ) )
                    {
                    // InternalPerl.g:545:4: ()
                    // InternalPerl.g:546:5: 
                    {
                    ...
                    // InternalPerl.g:552:4: ( (lv_content_7_0= RULE_REGEX_QUOTE ) )
                    // InternalPerl.g:553:5: (lv_content_7_0= RULE_REGEX_QUOTE )
                    {
                    // InternalPerl.g:553:5: (lv_content_7_0= RULE_REGEX_QUOTE )
                    // InternalPerl.g:554:6: lv_content_7_0= RULE_REGEX_QUOTE
                    {
                    ...
                    break;
                case 5 :
                    // InternalPerl.g:572:3: ( () ( (lv_content_9_0= RULE_READLINE_QUOTE ) ) )
                    {
                    // InternalPerl.g:572:3: ( () ( (lv_content_9_0= RULE_READLINE_QUOTE ) ) )
                    // InternalPerl.g:573:4: () ( (lv_content_9_0= RULE_READLINE_QUOTE ) )
                    {
                    // InternalPerl.g:573:4: ()
                    // InternalPerl.g:574:5: 
                    {
                    ...
                    // InternalPerl.g:580:4: ( (lv_content_9_0= RULE_READLINE_QUOTE ) )
                    // InternalPerl.g:581:5: (lv_content_9_0= RULE_READLINE_QUOTE )
                    {
                    // InternalPerl.g:581:5: (lv_content_9_0= RULE_READLINE_QUOTE )
                    // InternalPerl.g:582:6: lv_content_9_0= RULE_READLINE_QUOTE
                    {
    ...
    // InternalPerl.g:603:1: entryRuleNumber returns [String current=null] : iv_ruleNumber= ruleNumber EOF ;
    public final String entryRuleNumber() throws RecognitionException {
        ...
        try {
            // InternalPerl.g:605:2: (iv_ruleNumber= ruleNumber EOF )
            // InternalPerl.g:606:2: iv_ruleNumber= ruleNumber EOF
            {
    ...
    // InternalPerl.g:615:1: ruleNumber returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : ( (this_HEX_0= RULE_HEX | this_BIN_1= RULE_BIN | this_INT_2= RULE_INT ) (kw= '.' this_INT_4= RULE_INT )? ) ;
    public final AntlrDatatypeRuleToken ruleNumber() throws RecognitionException {
        ...
        try {
            // InternalPerl.g:622:2: ( ( (this_HEX_0= RULE_HEX | this_BIN_1= RULE_BIN | this_INT_2= RULE_INT ) (kw= '.' this_INT_4= RULE_INT )? ) )
            // InternalPerl.g:623:2: ( (this_HEX_0= RULE_HEX | this_BIN_1= RULE_BIN | this_INT_2= RULE_INT ) (kw= '.' this_INT_4= RULE_INT )? )
            {
            // InternalPerl.g:623:2: ( (this_HEX_0= RULE_HEX | this_BIN_1= RULE_BIN | this_INT_2= RULE_INT ) (kw= '.' this_INT_4= RULE_INT )? )
            // InternalPerl.g:624:3: (this_HEX_0= RULE_HEX | this_BIN_1= RULE_BIN | this_INT_2= RULE_INT ) (kw= '.' this_INT_4= RULE_INT )?
            {
            // InternalPerl.g:624:3: (this_HEX_0= RULE_HEX | this_BIN_1= RULE_BIN | this_INT_2= RULE_INT )
            int alt4=3;
            switch ( input.LA(1) ) {
            case RULE_HEX:
                {
            ...
            switch (alt4) {
                case 1 :
                    // InternalPerl.g:625:4: this_HEX_0= RULE_HEX
                    {
                    ...
                    break;
                case 2 :
                    // InternalPerl.g:633:4: this_BIN_1= RULE_BIN
                    {
                    ...
                    break;
                case 3 :
                    // InternalPerl.g:641:4: this_INT_2= RULE_INT
                    {
            ...
            // InternalPerl.g:649:3: (kw= '.' this_INT_4= RULE_INT )?
            int alt5=2;
            ...
            switch (alt5) {
                case 1 :
                    // InternalPerl.g:650:4: kw= '.' this_INT_4= RULE_INT
                    {
    ...
    // InternalPerl.g:670:1: entryRuleWord returns [String current=null] : iv_ruleWord= ruleWord EOF ;
    public final String entryRuleWord() throws RecognitionException {
        ...
        try {
            // InternalPerl.g:670:44: (iv_ruleWord= ruleWord EOF )
            // InternalPerl.g:671:2: iv_ruleWord= ruleWord EOF
            {
    ...
    // InternalPerl.g:677:1: ruleWord returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : this_Keyword_0= ruleKeyword ;
    public final AntlrDatatypeRuleToken ruleWord() throws RecognitionException {
        ...
        try {
            // InternalPerl.g:683:2: (this_Keyword_0= ruleKeyword )
            // InternalPerl.g:684:2: this_Keyword_0= ruleKeyword
            {
    ...
    // InternalPerl.g:697:1: entryRuleKeyword returns [String current=null] : iv_ruleKeyword= ruleKeyword EOF ;
    public final String entryRuleKeyword() throws RecognitionException {
        ...
        try {
            // InternalPerl.g:697:47: (iv_ruleKeyword= ruleKeyword EOF )
            // InternalPerl.g:698:2: iv_ruleKeyword= ruleKeyword EOF
            {
    ...
    public final AntlrDatatypeRuleToken ruleKeyword() throws RecognitionException {
        ...
        try {
            // InternalPerl.g:710:2: ( (kw= 'abs' | kw= 'accept' | kw= 'alarm' | kw= 'atan2' | kw= 'bind' | kw= 'binmode' | kw= 'bless' | kw= 'break' | kw= 'caller' | kw= 'chdir' | kw= 'chmod' | kw= 'chomp' | kw= 'chop' | kw= 'chown' | kw= 'chr' | kw= 'chroot' | kw= 'close' | kw= 'closedir' | kw= 'connect' | kw= 'continue' | kw= 'cos' | kw= 'crypt' | kw= 'dbmclose' | kw= 'dbmopen' | kw= 'default' | kw= 'defined' | kw= 'delete' | kw= 'die' | kw= 'do' | kw= 'dump' | kw= 'each' | kw= 'else' | kw= 'elsif' | kw= 'endgrent' | kw= 'endhostent' | kw= 'endnetent' | kw= 'endprotoent' | kw= 'endpwent' | kw= 'endservent' | kw= 'eof' | kw= 'eval' | kw= 'evalbytes' | kw= 'exec' | kw= 'exists' | kw= 'exit' | kw= 'exp' | kw= 'fc' | kw= 'fcntl' | kw= 'fileno' | kw= 'flock' | kw= 'for' | kw= 'foreach' | kw= 'fork' | kw= 'format' | kw= 'formline' | kw= 'getc' | kw= 'getgrent' | kw= 'getgrgid' | kw= 'getgrnam' | kw= 'gethostbyaddr' | kw= 'gethostbyname' | kw= 'gethostent' | kw= 'getlogin' | kw= 'getnetbyaddr' | kw= 'getnetbyname' | kw= 'getnetent' | kw= 'getpeername' | kw= 'getpgrp' | kw= 'getppid' | kw= 'getpriority' | kw= 'getprotobyname' | kw= 'getprotobynumber' | kw= 'getprotoent' | kw= 'getpwent' | kw= 'getpwnam' | kw= 'getpwuid' | kw= 'getservbyname' | kw= 'getservbyport' | kw= 'getservent' | kw= 'getsockname' | kw= 'getsockopt' | kw= 'given' | kw= 'glob' | kw= 'gmtime' | kw= 'goto' | kw= 'grep' | kw= 'hex' | kw= 'if' | kw= 'index' | kw= 'int' | kw= 'ioctl' | kw= 'join' | kw= 'keys' | kw= 'kill' | kw= 'last' | kw= 'lc' | kw= 'lcfirst' | kw= 'length' | kw= 'link' | kw= 'listen' | kw= 'local' | kw= 'localtime' | kw= 'lock' | kw= 'log' | kw= 'lstat' | kw= 'map' | kw= 'mkdir' | kw= 'msgctl' | kw= 'msgget' | kw= 'msgrcv' | kw= 'msgsnd' | kw= 'my' | kw= 'next' | kw= 'no' | kw= 'oct' | kw= 'open' | kw= 'opendir' | kw= 'ord' | kw= 'our' | kw= 'pack' | kw= 'package' | kw= 'pipe' | kw= 'pop' | kw= 'pos' | kw= 'print' | kw= 'printf' | kw= 'prototype' | kw= 'push' | kw= 'quotemeta' | kw= 'rand' | kw= 'read' | kw= 'readdir' | kw= 'readline' | kw= 'readlink' | kw= 'readpipe' | kw= 'recv' | kw= 'redo' | kw= 'ref' | kw= 'rename' | kw= 'require' | kw= 'reset' | kw= 'return' | kw= 'reverse' | kw= 'rewinddir' | kw= 'rindex' | kw= 'rmdir' | kw= 'say' | kw= 'scalar' | kw= 'seek' | kw= 'seekdir' | kw= 'select' | kw= 'semctl' | kw= 'semget' | kw= 'semop' | kw= 'send' | kw= 'setgrent' | kw= 'sethostent' | kw= 'setnetent' | kw= 'setpgrp' | kw= 'setpriority' | kw= 'setprotoent' | kw= 'setpwent' | kw= 'setservent' | kw= 'setsockopt' | kw= 'shift' | kw= 'shmctl' | kw= 'shmget' | kw= 'shmread' | kw= 'shmwrite' | kw= 'shutdown' | kw= 'sin' | kw= 'sleep' | kw= 'socket' | kw= 'socketpair' | kw= 'sort' | kw= 'splice' | kw= 'split' | kw= 'sprintf' | kw= 'sqrt' | kw= 'srand' | kw= 'stat' | kw= 'state' | kw= 'study' | kw= 'sub' | kw= 'substr' | kw= 'symlink' | kw= 'syscall' | kw= 'sysopen' | kw= 'sysread' | kw= 'sysseek' | kw= 'system' | kw= 'syswrite' | kw= 'tell' | kw= 'telldir' | kw= 'tie' | kw= 'tied' | kw= 'time' | kw= 'times' | kw= 'tr' | kw= 'truncate' | kw= 'uc' | kw= 'ucfirst' | kw= 'umask' | kw= 'undef' | kw= 'unless' | kw= 'unlink' | kw= 'unpack' | kw= 'unshift' | kw= 'untie' | kw= 'until' | kw= 'use' | kw= 'utime' | kw= 'values' | kw= 'vec' | kw= 'wait' | kw= 'waitpid' | kw= 'wantarray' | kw= 'warn' | kw= 'when' | kw= 'while' | kw= 'write' | kw= 'y' ) )
            // InternalPerl.g:711:2: (kw= 'abs' | kw= 'accept' | kw= 'alarm' | kw= 'atan2' | kw= 'bind' | kw= 'binmode' | kw= 'bless' | kw= 'break' | kw= 'caller' | kw= 'chdir' | kw= 'chmod' | kw= 'chomp' | kw= 'chop' | kw= 'chown' | kw= 'chr' | kw= 'chroot' | kw= 'close' | kw= 'closedir' | kw= 'connect' | kw= 'continue' | kw= 'cos' | kw= 'crypt' | kw= 'dbmclose' | kw= 'dbmopen' | kw= 'default' | kw= 'defined' | kw= 'delete' | kw= 'die' | kw= 'do' | kw= 'dump' | kw= 'each' | kw= 'else' | kw= 'elsif' | kw= 'endgrent' | kw= 'endhostent' | kw= 'endnetent' | kw= 'endprotoent' | kw= 'endpwent' | kw= 'endservent' | kw= 'eof' | kw= 'eval' | kw= 'evalbytes' | kw= 'exec' | kw= 'exists' | kw= 'exit' | kw= 'exp' | kw= 'fc' | kw= 'fcntl' | kw= 'fileno' | kw= 'flock' | kw= 'for' | kw= 'foreach' | kw= 'fork' | kw= 'format' | kw= 'formline' | kw= 'getc' | kw= 'getgrent' | kw= 'getgrgid' | kw= 'getgrnam' | kw= 'gethostbyaddr' | kw= 'gethostbyname' | kw= 'gethostent' | kw= 'getlogin' | kw= 'getnetbyaddr' | kw= 'getnetbyname' | kw= 'getnetent' | kw= 'getpeername' | kw= 'getpgrp' | kw= 'getppid' | kw= 'getpriority' | kw= 'getprotobyname' | kw= 'getprotobynumber' | kw= 'getprotoent' | kw= 'getpwent' | kw= 'getpwnam' | kw= 'getpwuid' | kw= 'getservbyname' | kw= 'getservbyport' | kw= 'getservent' | kw= 'getsockname' | kw= 'getsockopt' | kw= 'given' | kw= 'glob' | kw= 'gmtime' | kw= 'goto' | kw= 'grep' | kw= 'hex' | kw= 'if' | kw= 'index' | kw= 'int' | kw= 'ioctl' | kw= 'join' | kw= 'keys' | kw= 'kill' | kw= 'last' | kw= 'lc' | kw= 'lcfirst' | kw= 'length' | kw= 'link' | kw= 'listen' | kw= 'local' | kw= 'localtime' | kw= 'lock' | kw= 'log' | kw= 'lstat' | kw= 'map' | kw= 'mkdir' | kw= 'msgctl' | kw= 'msgget' | kw= 'msgrcv' | kw= 'msgsnd' | kw= 'my' | kw= 'next' | kw= 'no' | kw= 'oct' | kw= 'open' | kw= 'opendir' | kw= 'ord' | kw= 'our' | kw= 'pack' | kw= 'package' | kw= 'pipe' | kw= 'pop' | kw= 'pos' | kw= 'print' | kw= 'printf' | kw= 'prototype' | kw= 'push' | kw= 'quotemeta' | kw= 'rand' | kw= 'read' | kw= 'readdir' | kw= 'readline' | kw= 'readlink' | kw= 'readpipe' | kw= 'recv' | kw= 'redo' | kw= 'ref' | kw= 'rename' | kw= 'require' | kw= 'reset' | kw= 'return' | kw= 'reverse' | kw= 'rewinddir' | kw= 'rindex' | kw= 'rmdir' | kw= 'say' | kw= 'scalar' | kw= 'seek' | kw= 'seekdir' | kw= 'select' | kw= 'semctl' | kw= 'semget' | kw= 'semop' | kw= 'send' | kw= 'setgrent' | kw= 'sethostent' | kw= 'setnetent' | kw= 'setpgrp' | kw= 'setpriority' | kw= 'setprotoent' | kw= 'setpwent' | kw= 'setservent' | kw= 'setsockopt' | kw= 'shift' | kw= 'shmctl' | kw= 'shmget' | kw= 'shmread' | kw= 'shmwrite' | kw= 'shutdown' | kw= 'sin' | kw= 'sleep' | kw= 'socket' | kw= 'socketpair' | kw= 'sort' | kw= 'splice' | kw= 'split' | kw= 'sprintf' | kw= 'sqrt' | kw= 'srand' | kw= 'stat' | kw= 'state' | kw= 'study' | kw= 'sub' | kw= 'substr' | kw= 'symlink' | kw= 'syscall' | kw= 'sysopen' | kw= 'sysread' | kw= 'sysseek' | kw= 'system' | kw= 'syswrite' | kw= 'tell' | kw= 'telldir' | kw= 'tie' | kw= 'tied' | kw= 'time' | kw= 'times' | kw= 'tr' | kw= 'truncate' | kw= 'uc' | kw= 'ucfirst' | kw= 'umask' | kw= 'undef' | kw= 'unless' | kw= 'unlink' | kw= 'unpack' | kw= 'unshift' | kw= 'untie' | kw= 'until' | kw= 'use' | kw= 'utime' | kw= 'values' | kw= 'vec' | kw= 'wait' | kw= 'waitpid' | kw= 'wantarray' | kw= 'warn' | kw= 'when' | kw= 'while' | kw= 'write' | kw= 'y' )
            {
            // InternalPerl.g:711:2: (kw= 'abs' | kw= 'accept' | kw= 'alarm' | kw= 'atan2' | kw= 'bind' | kw= 'binmode' | kw= 'bless' | kw= 'break' | kw= 'caller' | kw= 'chdir' | kw= 'chmod' | kw= 'chomp' | kw= 'chop' | kw= 'chown' | kw= 'chr' | kw= 'chroot' | kw= 'close' | kw= 'closedir' | kw= 'connect' | kw= 'continue' | kw= 'cos' | kw= 'crypt' | kw= 'dbmclose' | kw= 'dbmopen' | kw= 'default' | kw= 'defined' | kw= 'delete' | kw= 'die' | kw= 'do' | kw= 'dump' | kw= 'each' | kw= 'else' | kw= 'elsif' | kw= 'endgrent' | kw= 'endhostent' | kw= 'endnetent' | kw= 'endprotoent' | kw= 'endpwent' | kw= 'endservent' | kw= 'eof' | kw= 'eval' | kw= 'evalbytes' | kw= 'exec' | kw= 'exists' | kw= 'exit' | kw= 'exp' | kw= 'fc' | kw= 'fcntl' | kw= 'fileno' | kw= 'flock' | kw= 'for' | kw= 'foreach' | kw= 'fork' | kw= 'format' | kw= 'formline' | kw= 'getc' | kw= 'getgrent' | kw= 'getgrgid' | kw= 'getgrnam' | kw= 'gethostbyaddr' | kw= 'gethostbyname' | kw= 'gethostent' | kw= 'getlogin' | kw= 'getnetbyaddr' | kw= 'getnetbyname' | kw= 'getnetent' | kw= 'getpeername' | kw= 'getpgrp' | kw= 'getppid' | kw= 'getpriority' | kw= 'getprotobyname' | kw= 'getprotobynumber' | kw= 'getprotoent' | kw= 'getpwent' | kw= 'getpwnam' | kw= 'getpwuid' | kw= 'getservbyname' | kw= 'getservbyport' | kw= 'getservent' | kw= 'getsockname' | kw= 'getsockopt' | kw= 'given' | kw= 'glob' | kw= 'gmtime' | kw= 'goto' | kw= 'grep' | kw= 'hex' | kw= 'if' | kw= 'index' | kw= 'int' | kw= 'ioctl' | kw= 'join' | kw= 'keys' | kw= 'kill' | kw= 'last' | kw= 'lc' | kw= 'lcfirst' | kw= 'length' | kw= 'link' | kw= 'listen' | kw= 'local' | kw= 'localtime' | kw= 'lock' | kw= 'log' | kw= 'lstat' | kw= 'map' | kw= 'mkdir' | kw= 'msgctl' | kw= 'msgget' | kw= 'msgrcv' | kw= 'msgsnd' | kw= 'my' | kw= 'next' | kw= 'no' | kw= 'oct' | kw= 'open' | kw= 'opendir' | kw= 'ord' | kw= 'our' | kw= 'pack' | kw= 'package' | kw= 'pipe' | kw= 'pop' | kw= 'pos' | kw= 'print' | kw= 'printf' | kw= 'prototype' | kw= 'push' | kw= 'quotemeta' | kw= 'rand' | kw= 'read' | kw= 'readdir' | kw= 'readline' | kw= 'readlink' | kw= 'readpipe' | kw= 'recv' | kw= 'redo' | kw= 'ref' | kw= 'rename' | kw= 'require' | kw= 'reset' | kw= 'return' | kw= 'reverse' | kw= 'rewinddir' | kw= 'rindex' | kw= 'rmdir' | kw= 'say' | kw= 'scalar' | kw= 'seek' | kw= 'seekdir' | kw= 'select' | kw= 'semctl' | kw= 'semget' | kw= 'semop' | kw= 'send' | kw= 'setgrent' | kw= 'sethostent' | kw= 'setnetent' | kw= 'setpgrp' | kw= 'setpriority' | kw= 'setprotoent' | kw= 'setpwent' | kw= 'setservent' | kw= 'setsockopt' | kw= 'shift' | kw= 'shmctl' | kw= 'shmget' | kw= 'shmread' | kw= 'shmwrite' | kw= 'shutdown' | kw= 'sin' | kw= 'sleep' | kw= 'socket' | kw= 'socketpair' | kw= 'sort' | kw= 'splice' | kw= 'split' | kw= 'sprintf' | kw= 'sqrt' | kw= 'srand' | kw= 'stat' | kw= 'state' | kw= 'study' | kw= 'sub' | kw= 'substr' | kw= 'symlink' | kw= 'syscall' | kw= 'sysopen' | kw= 'sysread' | kw= 'sysseek' | kw= 'system' | kw= 'syswrite' | kw= 'tell' | kw= 'telldir' | kw= 'tie' | kw= 'tied' | kw= 'time' | kw= 'times' | kw= 'tr' | kw= 'truncate' | kw= 'uc' | kw= 'ucfirst' | kw= 'umask' | kw= 'undef' | kw= 'unless' | kw= 'unlink' | kw= 'unpack' | kw= 'unshift' | kw= 'untie' | kw= 'until' | kw= 'use' | kw= 'utime' | kw= 'values' | kw= 'vec' | kw= 'wait' | kw= 'waitpid' | kw= 'wantarray' | kw= 'warn' | kw= 'when' | kw= 'while' | kw= 'write' | kw= 'y' )
            int alt6=222;
            switch ( input.LA(1) ) {
            ...
            switch (alt6) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalPerl.g:718:3: kw= 'accept'
                    {
                ...
                case 5 :
                    ...
                    break;
                case 6 :
                    // InternalPerl.g:742:3: kw= 'binmode'
                    {
                ...
                case 8 :
                    ...
                    break;
                case 9 :
                    // InternalPerl.g:760:3: kw= 'caller'
                    {
                ...
                case 15 :
                    ...
                    break;
                case 16 :
                    // InternalPerl.g:802:3: kw= 'chroot'
                    {
                ...
                case 17 :
                    ...
                    break;
                case 18 :
                    // InternalPerl.g:814:3: kw= 'closedir'
                    {
                    ...
                    break;
                case 19 :
                    // InternalPerl.g:820:3: kw= 'connect'
                    {
                    ...
                    break;
                case 20 :
                    // InternalPerl.g:826:3: kw= 'continue'
                    {
                ...
                case 22 :
                    ...
                    break;
                case 23 :
                    // InternalPerl.g:844:3: kw= 'dbmclose'
                    {
                    ...
                    break;
                case 24 :
                    // InternalPerl.g:850:3: kw= 'dbmopen'
                    {
                    ...
                    break;
                case 25 :
                    // InternalPerl.g:856:3: kw= 'default'
                    {
                    ...
                    break;
                case 26 :
                    // InternalPerl.g:862:3: kw= 'defined'
                    {
                    ...
                    break;
                case 27 :
                    // InternalPerl.g:868:3: kw= 'delete'
                    {
                ...
                case 33 :
                    ...
                    break;
                case 34 :
                    // InternalPerl.g:910:3: kw= 'endgrent'
                    {
                    ...
                    break;
                case 35 :
                    // InternalPerl.g:916:3: kw= 'endhostent'
                    {
                    ...
                    break;
                case 36 :
                    // InternalPerl.g:922:3: kw= 'endnetent'
                    {
                    ...
                    break;
                case 37 :
                    // InternalPerl.g:928:3: kw= 'endprotoent'
                    {
                    ...
                    break;
                case 38 :
                    // InternalPerl.g:934:3: kw= 'endpwent'
                    {
                    ...
                    break;
                case 39 :
                    // InternalPerl.g:940:3: kw= 'endservent'
                    {
                ...
                case 41 :
                    ...
                    break;
                case 42 :
                    // InternalPerl.g:958:3: kw= 'evalbytes'
                    {
                ...
                case 43 :
                    ...
                    break;
                case 44 :
                    // InternalPerl.g:970:3: kw= 'exists'
                    {
                ...
                case 48 :
                    ...
                    break;
                case 49 :
                    // InternalPerl.g:1000:3: kw= 'fileno'
                    {
                    ...
                    break;
                case 50 :
                    // InternalPerl.g:1006:3: kw= 'flock'
                    {
                ...
                case 51 :
                    ...
                    break;
                case 52 :
                    // InternalPerl.g:1018:3: kw= 'foreach'
                    {
                ...
                case 53 :
                    ...
                    break;
                case 54 :
                    // InternalPerl.g:1030:3: kw= 'format'
                    {
                    ...
                    break;
                case 55 :
                    // InternalPerl.g:1036:3: kw= 'formline'
                    {
                ...
                case 56 :
                    ...
                    break;
                case 57 :
                    // InternalPerl.g:1048:3: kw= 'getgrent'
                    {
                    ...
                    break;
                case 58 :
                    // InternalPerl.g:1054:3: kw= 'getgrgid'
                    {
                    ...
                    break;
                case 59 :
                    // InternalPerl.g:1060:3: kw= 'getgrnam'
                    {
                    ...
                    break;
                case 60 :
                    // InternalPerl.g:1066:3: kw= 'gethostbyaddr'
                    {
                    ...
                    break;
                case 61 :
                    // InternalPerl.g:1072:3: kw= 'gethostbyname'
                    {
                    ...
                    break;
                case 62 :
                    // InternalPerl.g:1078:3: kw= 'gethostent'
                    {
                    ...
                    break;
                case 63 :
                    // InternalPerl.g:1084:3: kw= 'getlogin'
                    {
                    ...
                    break;
                case 64 :
                    // InternalPerl.g:1090:3: kw= 'getnetbyaddr'
                    {
                    ...
                    break;
                case 65 :
                    // InternalPerl.g:1096:3: kw= 'getnetbyname'
                    {
                    ...
                    break;
                case 66 :
                    // InternalPerl.g:1102:3: kw= 'getnetent'
                    {
                    ...
                    break;
                case 67 :
                    // InternalPerl.g:1108:3: kw= 'getpeername'
                    {
                    ...
                    break;
                case 68 :
                    // InternalPerl.g:1114:3: kw= 'getpgrp'
                    {
                    ...
                    break;
                case 69 :
                    // InternalPerl.g:1120:3: kw= 'getppid'
                    {
                    ...
                    break;
                case 70 :
                    // InternalPerl.g:1126:3: kw= 'getpriority'
                    {
                    ...
                    break;
                case 71 :
                    // InternalPerl.g:1132:3: kw= 'getprotobyname'
                    {
                    ...
                    break;
                case 72 :
                    // InternalPerl.g:1138:3: kw= 'getprotobynumber'
                    {
                    ...
                    break;
                case 73 :
                    // InternalPerl.g:1144:3: kw= 'getprotoent'
                    {
                    ...
                    break;
                case 74 :
                    // InternalPerl.g:1150:3: kw= 'getpwent'
                    {
                    ...
                    break;
                case 75 :
                    // InternalPerl.g:1156:3: kw= 'getpwnam'
                    {
                    ...
                    break;
                case 76 :
                    // InternalPerl.g:1162:3: kw= 'getpwuid'
                    {
                    ...
                    break;
                case 77 :
                    // InternalPerl.g:1168:3: kw= 'getservbyname'
                    {
                    ...
                    break;
                case 78 :
                    // InternalPerl.g:1174:3: kw= 'getservbyport'
                    {
                    ...
                    break;
                case 79 :
                    // InternalPerl.g:1180:3: kw= 'getservent'
                    {
                    ...
                    break;
                case 80 :
                    // InternalPerl.g:1186:3: kw= 'getsockname'
                    {
                    ...
                    break;
                case 81 :
                    // InternalPerl.g:1192:3: kw= 'getsockopt'
                    {
                    ...
                    break;
                case 82 :
                    // InternalPerl.g:1198:3: kw= 'given'
                    {
                ...
                case 83 :
                    ...
                    break;
                case 84 :
                    // InternalPerl.g:1210:3: kw= 'gmtime'
                    {
                ...
                case 88 :
                    ...
                    break;
                case 89 :
                    // InternalPerl.g:1240:3: kw= 'index'
                    {
                ...
                case 90 :
                    ...
                    break;
                case 91 :
                    // InternalPerl.g:1252:3: kw= 'ioctl'
                    {
                ...
                case 96 :
                    ...
                    break;
                case 97 :
                    // InternalPerl.g:1288:3: kw= 'lcfirst'
                    {
                    ...
                    break;
                case 98 :
                    // InternalPerl.g:1294:3: kw= 'length'
                    {
                ...
                case 99 :
                    ...
                    break;
                case 100 :
                    // InternalPerl.g:1306:3: kw= 'listen'
                    {
                    ...
                    break;
                case 101 :
                    // InternalPerl.g:1312:3: kw= 'local'
                    {
                    ...
                    break;
                case 102 :
                    // InternalPerl.g:1318:3: kw= 'localtime'
                    {
                ...
                case 104 :
                    ...
                    break;
                case 105 :
                    // InternalPerl.g:1336:3: kw= 'lstat'
                    {
                ...
                case 106 :
                    ...
                    break;
                case 107 :
                    // InternalPerl.g:1348:3: kw= 'mkdir'
                    {
                    ...
                    break;
                case 108 :
                    // InternalPerl.g:1354:3: kw= 'msgctl'
                    {
                    ...
                    break;
                case 109 :
                    // InternalPerl.g:1360:3: kw= 'msgget'
                    {
                    ...
                    break;
                case 110 :
                    // InternalPerl.g:1366:3: kw= 'msgrcv'
                    {
                    ...
                    break;
                case 111 :
                    // InternalPerl.g:1372:3: kw= 'msgsnd'
                    {
                ...
                case 116 :
                    ...
                    break;
                case 117 :
                    // InternalPerl.g:1408:3: kw= 'opendir'
                    {
                ...
                case 120 :
                    ...
                    break;
                case 121 :
                    // InternalPerl.g:1432:3: kw= 'package'
                    {
                ...
                case 124 :
                    ...
                    break;
                case 125 :
                    // InternalPerl.g:1456:3: kw= 'print'
                    {
                    ...
                    break;
                case 126 :
                    // InternalPerl.g:1462:3: kw= 'printf'
                    {
                    ...
                    break;
                case 127 :
                    // InternalPerl.g:1468:3: kw= 'prototype'
                    {
                ...
                case 128 :
                    ...
                    break;
                case 129 :
                    // InternalPerl.g:1480:3: kw= 'quotemeta'
                    {
                ...
                case 131 :
                    ...
                    break;
                case 132 :
                    // InternalPerl.g:1498:3: kw= 'readdir'
                    {
                    ...
                    break;
                case 133 :
                    // InternalPerl.g:1504:3: kw= 'readline'
                    {
                    ...
                    break;
                case 134 :
                    // InternalPerl.g:1510:3: kw= 'readlink'
                    {
                    ...
                    break;
                case 135 :
                    // InternalPerl.g:1516:3: kw= 'readpipe'
                    {
                ...
                case 138 :
                    ...
                    break;
                case 139 :
                    // InternalPerl.g:1540:3: kw= 'rename'
                    {
                    ...
                    break;
                case 140 :
                    // InternalPerl.g:1546:3: kw= 'require'
                    {
                    ...
                    break;
                case 141 :
                    // InternalPerl.g:1552:3: kw= 'reset'
                    {
                    ...
                    break;
                case 142 :
                    // InternalPerl.g:1558:3: kw= 'return'
                    {
                    ...
                    break;
                case 143 :
                    // InternalPerl.g:1564:3: kw= 'reverse'
                    {
                    ...
                    break;
                case 144 :
                    // InternalPerl.g:1570:3: kw= 'rewinddir'
                    {
                    ...
                    break;
                case 145 :
                    // InternalPerl.g:1576:3: kw= 'rindex'
                    {
                    ...
                    break;
                case 146 :
                    // InternalPerl.g:1582:3: kw= 'rmdir'
                    {
                ...
                case 147 :
                    ...
                    break;
                case 148 :
                    // InternalPerl.g:1594:3: kw= 'scalar'
                    {
                ...
                case 149 :
                    ...
                    break;
                case 150 :
                    // InternalPerl.g:1606:3: kw= 'seekdir'
                    {
                    ...
                    break;
                case 151 :
                    // InternalPerl.g:1612:3: kw= 'select'
                    {
                    ...
                    break;
                case 152 :
                    // InternalPerl.g:1618:3: kw= 'semctl'
                    {
                    ...
                    break;
                case 153 :
                    // InternalPerl.g:1624:3: kw= 'semget'
                    {
                    ...
                    break;
                case 154 :
                    // InternalPerl.g:1630:3: kw= 'semop'
                    {
                ...
                case 155 :
                    ...
                    break;
                case 156 :
                    // InternalPerl.g:1642:3: kw= 'setgrent'
                    {
                    ...
                    break;
                case 157 :
                    // InternalPerl.g:1648:3: kw= 'sethostent'
                    {
                    ...
                    break;
                case 158 :
                    // InternalPerl.g:1654:3: kw= 'setnetent'
                    {
                    ...
                    break;
                case 159 :
                    // InternalPerl.g:1660:3: kw= 'setpgrp'
                    {
                    ...
                    break;
                case 160 :
                    // InternalPerl.g:1666:3: kw= 'setpriority'
                    {
                    ...
                    break;
                case 161 :
                    // InternalPerl.g:1672:3: kw= 'setprotoent'
                    {
                    ...
                    break;
                case 162 :
                    // InternalPerl.g:1678:3: kw= 'setpwent'
                    {
                    ...
                    break;
                case 163 :
                    // InternalPerl.g:1684:3: kw= 'setservent'
                    {
                    ...
                    break;
                case 164 :
                    // InternalPerl.g:1690:3: kw= 'setsockopt'
                    {
                    ...
                    break;
                case 165 :
                    // InternalPerl.g:1696:3: kw= 'shift'
                    {
                    ...
                    break;
                case 166 :
                    // InternalPerl.g:1702:3: kw= 'shmctl'
                    {
                    ...
                    break;
                case 167 :
                    // InternalPerl.g:1708:3: kw= 'shmget'
                    {
                    ...
                    break;
                case 168 :
                    // InternalPerl.g:1714:3: kw= 'shmread'
                    {
                    ...
                    break;
                case 169 :
                    // InternalPerl.g:1720:3: kw= 'shmwrite'
                    {
                    ...
                    break;
                case 170 :
                    // InternalPerl.g:1726:3: kw= 'shutdown'
                    {
                ...
                case 171 :
                    ...
                    break;
                case 172 :
                    // InternalPerl.g:1738:3: kw= 'sleep'
                    {
                    ...
                    break;
                case 173 :
                    // InternalPerl.g:1744:3: kw= 'socket'
                    {
                    ...
                    break;
                case 174 :
                    // InternalPerl.g:1750:3: kw= 'socketpair'
                    {
                ...
                case 175 :
                    ...
                    break;
                case 176 :
                    // InternalPerl.g:1762:3: kw= 'splice'
                    {
                    ...
                    break;
                case 177 :
                    // InternalPerl.g:1768:3: kw= 'split'
                    {
                    ...
                    break;
                case 178 :
                    // InternalPerl.g:1774:3: kw= 'sprintf'
                    {
                ...
                case 179 :
                    ...
                    break;
                case 180 :
                    // InternalPerl.g:1786:3: kw= 'srand'
                    {
                ...
                case 181 :
                    ...
                    break;
                case 182 :
                    // InternalPerl.g:1798:3: kw= 'state'
                    {
                    ...
                    break;
                case 183 :
                    // InternalPerl.g:1804:3: kw= 'study'
                    {
                ...
                case 184 :
                    ...
                    break;
                case 185 :
                    // InternalPerl.g:1816:3: kw= 'substr'
                    {
                    ...
                    break;
                case 186 :
                    // InternalPerl.g:1822:3: kw= 'symlink'
                    {
                    ...
                    break;
                case 187 :
                    // InternalPerl.g:1828:3: kw= 'syscall'
                    {
                    ...
                    break;
                case 188 :
                    // InternalPerl.g:1834:3: kw= 'sysopen'
                    {
                    ...
                    break;
                case 189 :
                    // InternalPerl.g:1840:3: kw= 'sysread'
                    {
                    ...
                    break;
                case 190 :
                    // InternalPerl.g:1846:3: kw= 'sysseek'
                    {
                    ...
                    break;
                case 191 :
                    // InternalPerl.g:1852:3: kw= 'system'
                    {
                    ...
                    break;
                case 192 :
                    // InternalPerl.g:1858:3: kw= 'syswrite'
                    {
                ...
                case 193 :
                    ...
                    break;
                case 194 :
                    // InternalPerl.g:1870:3: kw= 'telldir'
                    {
                ...
                case 197 :
                    ...
                    break;
                case 198 :
                    // InternalPerl.g:1894:3: kw= 'times'
                    {
                ...
                case 199 :
                    ...
                    break;
                case 200 :
                    // InternalPerl.g:1906:3: kw= 'truncate'
                    {
                ...
                case 201 :
                    ...
                    break;
                case 202 :
                    // InternalPerl.g:1918:3: kw= 'ucfirst'
                    {
                    ...
                    break;
                case 203 :
                    // InternalPerl.g:1924:3: kw= 'umask'
                    {
                    ...
                    break;
                case 204 :
                    // InternalPerl.g:1930:3: kw= 'undef'
                    {
                    ...
                    break;
                case 205 :
                    // InternalPerl.g:1936:3: kw= 'unless'
                    {
                    ...
                    break;
                case 206 :
                    // InternalPerl.g:1942:3: kw= 'unlink'
                    {
                    ...
                    break;
                case 207 :
                    // InternalPerl.g:1948:3: kw= 'unpack'
                    {
                    ...
                    break;
                case 208 :
                    // InternalPerl.g:1954:3: kw= 'unshift'
                    {
                    ...
                    break;
                case 209 :
                    // InternalPerl.g:1960:3: kw= 'untie'
                    {
                    ...
                    break;
                case 210 :
                    // InternalPerl.g:1966:3: kw= 'until'
                    {
                ...
                case 211 :
                    ...
                    break;
                case 212 :
                    // InternalPerl.g:1978:3: kw= 'utime'
                    {
                    ...
                    break;
                case 213 :
                    // InternalPerl.g:1984:3: kw= 'values'
                    {
                ...
                case 215 :
                    ...
                    break;
                case 216 :
                    // InternalPerl.g:2002:3: kw= 'waitpid'
                    {
                    ...
                    break;
                case 217 :
                    // InternalPerl.g:2008:3: kw= 'wantarray'
                    {
                ...
                case 219 :
                    ...
                    break;
                case 220 :
                    // InternalPerl.g:2026:3: kw= 'while'
                    {
                    ...
                    break;
                case 221 :
                    // InternalPerl.g:2032:3: kw= 'write'
                    {
    ...
    // InternalPerl.g:2047:1: entryRuleOperator returns [String current=null] : iv_ruleOperator= ruleOperator EOF ;
    public final String entryRuleOperator() throws RecognitionException {
        ...
        try {
            // InternalPerl.g:2047:48: (iv_ruleOperator= ruleOperator EOF )
            // InternalPerl.g:2048:2: iv_ruleOperator= ruleOperator EOF
            {
    ...
    public final AntlrDatatypeRuleToken ruleOperator() throws RecognitionException {
        ...
        try {
            // InternalPerl.g:2060:2: ( (kw= '++' | kw= '--' | kw= '**' | kw= '!' | kw= '~' | kw= '+' | kw= '-' | kw= '=~' | kw= '!~' | kw= '*' | kw= '/' | kw= '%' | kw= 'x' | kw= '<<' | kw= '>>' | kw= 'lt' | kw= 'gt' | kw= 'le' | kw= 'ge' | kw= 'cmp' | kw= '~~' | kw= '==' | kw= '!=' | (kw= '<=>' kw= '.' ) | kw= '..' | kw= '...' | kw= ',' | kw= '&' | kw= '|' | kw= '^' | kw= '&&' | kw= '||' | kw= '//' | kw= '?' | kw= ':' | kw= '**=' | kw= '+=' | kw= '-=' | kw= '.=' | kw= '*=' | kw= '/=' | kw= '%=' | kw= 'x=' | kw= '&=' | kw= '|=' | kw= '^=' | kw= '<<=' | kw= '>>=' | kw= '&&=' | kw= '||=' | kw= '//=' | kw= '<' | kw= '>' | kw= '<=' | kw= '>=' | kw= '<>' | kw= '=>' | kw= '->' | kw= 'and' | kw= 'or' | kw= 'xor' | kw= 'not' | kw= 'eq' | kw= 'ne' ) )
            // InternalPerl.g:2061:2: (kw= '++' | kw= '--' | kw= '**' | kw= '!' | kw= '~' | kw= '+' | kw= '-' | kw= '=~' | kw= '!~' | kw= '*' | kw= '/' | kw= '%' | kw= 'x' | kw= '<<' | kw= '>>' | kw= 'lt' | kw= 'gt' | kw= 'le' | kw= 'ge' | kw= 'cmp' | kw= '~~' | kw= '==' | kw= '!=' | (kw= '<=>' kw= '.' ) | kw= '..' | kw= '...' | kw= ',' | kw= '&' | kw= '|' | kw= '^' | kw= '&&' | kw= '||' | kw= '//' | kw= '?' | kw= ':' | kw= '**=' | kw= '+=' | kw= '-=' | kw= '.=' | kw= '*=' | kw= '/=' | kw= '%=' | kw= 'x=' | kw= '&=' | kw= '|=' | kw= '^=' | kw= '<<=' | kw= '>>=' | kw= '&&=' | kw= '||=' | kw= '//=' | kw= '<' | kw= '>' | kw= '<=' | kw= '>=' | kw= '<>' | kw= '=>' | kw= '->' | kw= 'and' | kw= 'or' | kw= 'xor' | kw= 'not' | kw= 'eq' | kw= 'ne' )
            {
            // InternalPerl.g:2061:2: (kw= '++' | kw= '--' | kw= '**' | kw= '!' | kw= '~' | kw= '+' | kw= '-' | kw= '=~' | kw= '!~' | kw= '*' | kw= '/' | kw= '%' | kw= 'x' | kw= '<<' | kw= '>>' | kw= 'lt' | kw= 'gt' | kw= 'le' | kw= 'ge' | kw= 'cmp' | kw= '~~' | kw= '==' | kw= '!=' | (kw= '<=>' kw= '.' ) | kw= '..' | kw= '...' | kw= ',' | kw= '&' | kw= '|' | kw= '^' | kw= '&&' | kw= '||' | kw= '//' | kw= '?' | kw= ':' | kw= '**=' | kw= '+=' | kw= '-=' | kw= '.=' | kw= '*=' | kw= '/=' | kw= '%=' | kw= 'x=' | kw= '&=' | kw= '|=' | kw= '^=' | kw= '<<=' | kw= '>>=' | kw= '&&=' | kw= '||=' | kw= '//=' | kw= '<' | kw= '>' | kw= '<=' | kw= '>=' | kw= '<>' | kw= '=>' | kw= '->' | kw= 'and' | kw= 'or' | kw= 'xor' | kw= 'not' | kw= 'eq' | kw= 'ne' )
            int alt7=64;
            switch ( input.LA(1) ) {
            ...
            switch (alt7) {
                ...
                case 23 :
                    ...
                    break;
                case 24 :
                    // InternalPerl.g:2200:3: (kw= '<=>' kw= '.' )
                    {
                    // InternalPerl.g:2200:3: (kw= '<=>' kw= '.' )
                    // InternalPerl.g:2201:4: kw= '<=>' kw= '.'
                    {
                    kw=(Token)match(input,267,FOLLOW_6); 
    ...
    // InternalPerl.g:2456:1: entryRuleFileTestOperator returns [String current=null] : iv_ruleFileTestOperator= ruleFileTestOperator EOF ;
    public final String entryRuleFileTestOperator() throws RecognitionException {
        ...
        try {
            // InternalPerl.g:2456:56: (iv_ruleFileTestOperator= ruleFileTestOperator EOF )
            // InternalPerl.g:2457:2: iv_ruleFileTestOperator= ruleFileTestOperator EOF
            {
    ...
    // InternalPerl.g:2463:1: ruleFileTestOperator returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (kw= '-r' | kw= '-w' | kw= '-x' | kw= '-o' | kw= '-R' | kw= '-W' | kw= '-X' | kw= '-O' | kw= '-e' | kw= '-z' | kw= '-s' | kw= '-f' | kw= '-d' | kw= '-l' | kw= '-p' | kw= '-S' | kw= '-b' | kw= '-c' | kw= '-t' | kw= '-u' | kw= '-g' | kw= '-k' | kw= '-T' | kw= '-B' | kw= '-M' | kw= '-A' | kw= '-C' ) ;
    public final AntlrDatatypeRuleToken ruleFileTestOperator() throws RecognitionException {
        ...
        try {
            // InternalPerl.g:2469:2: ( (kw= '-r' | kw= '-w' | kw= '-x' | kw= '-o' | kw= '-R' | kw= '-W' | kw= '-X' | kw= '-O' | kw= '-e' | kw= '-z' | kw= '-s' | kw= '-f' | kw= '-d' | kw= '-l' | kw= '-p' | kw= '-S' | kw= '-b' | kw= '-c' | kw= '-t' | kw= '-u' | kw= '-g' | kw= '-k' | kw= '-T' | kw= '-B' | kw= '-M' | kw= '-A' | kw= '-C' ) )
            // InternalPerl.g:2470:2: (kw= '-r' | kw= '-w' | kw= '-x' | kw= '-o' | kw= '-R' | kw= '-W' | kw= '-X' | kw= '-O' | kw= '-e' | kw= '-z' | kw= '-s' | kw= '-f' | kw= '-d' | kw= '-l' | kw= '-p' | kw= '-S' | kw= '-b' | kw= '-c' | kw= '-t' | kw= '-u' | kw= '-g' | kw= '-k' | kw= '-T' | kw= '-B' | kw= '-M' | kw= '-A' | kw= '-C' )
            {
            // InternalPerl.g:2470:2: (kw= '-r' | kw= '-w' | kw= '-x' | kw= '-o' | kw= '-R' | kw= '-W' | kw= '-X' | kw= '-O' | kw= '-e' | kw= '-z' | kw= '-s' | kw= '-f' | kw= '-d' | kw= '-l' | kw= '-p' | kw= '-S' | kw= '-b' | kw= '-c' | kw= '-t' | kw= '-u' | kw= '-g' | kw= '-k' | kw= '-T' | kw= '-B' | kw= '-M' | kw= '-A' | kw= '-C' )
            int alt8=27;
            switch ( input.LA(1) ) {
    ...
    public static final BitSet FOLLOW_3 = new BitSet(new long[]{0xFFFFFFFFFFC3FFF2L,0xFFFFFFFFFFFFFFFFL,0xFFFFFFFFFFFFFFFFL,0xFFFFFFFFFFFFFFFFL,0xFFFFFFFFFFFFFFFFL,0x0000000000007FFFL});
