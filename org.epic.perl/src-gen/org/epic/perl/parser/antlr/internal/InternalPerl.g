...
@after {
	...
	(
		...
		{
			$current = $this_StatementNode_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_StructureNode_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleStatementNode returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getStatementNodeRule()); }
	iv_ruleStatementNode=ruleStatementNode
	{ $current=$iv_ruleStatementNode.current; }
	EOF;

// Rule StatementNode
ruleStatementNode returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	{
		$current = $this_SubStatement_0.current;
		afterParserOrEnumRuleCall();
	}
;
...
@after {
	...
	(
		(
			...
			{
				$current = $this_PackageStatement_0.current;
				afterParserOrEnumRuleCall();
			}
			    |
			{
			...
			{
				$current = $this_IncludeStatement_1.current;
				afterParserOrEnumRuleCall();
			}
		)
		otherlv_2=';'
...
// Entry rule entryRuleStructureNode
entryRuleStructureNode returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getStructureNodeRule()); }
	iv_ruleStructureNode=ruleStructureNode
	{ $current=$iv_ruleStructureNode.current; }
	EOF;

// Rule StructureNode
ruleStructureNode returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	{
		$current = $this_BlockStructure_0.current;
		afterParserOrEnumRuleCall();
	}
;
...
@after {
	...
	(
		...
		{
			$current = $this_RequireInclude_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_UseInclude_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleRequireInclude returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getRequireIncludeRule()); }
	iv_ruleRequireInclude=ruleRequireInclude
	{ $current=$iv_ruleRequireInclude.current; }
	EOF;

// Rule RequireInclude
ruleRequireInclude returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleUseInclude returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getUseIncludeRule()); }
	iv_ruleUseInclude=ruleUseInclude
	{ $current=$iv_ruleUseInclude.current; }
	EOF;

// Rule UseInclude
ruleUseInclude returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Entry rule entryRuleBlockStructure
entryRuleBlockStructure returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getBlockStructureRule()); }
	iv_ruleBlockStructure=ruleBlockStructure
	{ $current=$iv_ruleBlockStructure.current; }
	EOF;

// Rule BlockStructure
ruleBlockStructure returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRulePrototype returns [String current=null]:
	{ newCompositeNode(grammarAccess.getPrototypeRule()); }
	iv_rulePrototype=rulePrototype
	{ $current=$iv_rulePrototype.current.getText(); }
	EOF;

// Rule Prototype
rulePrototype returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_QuoteToken_13.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
...
entryRuleQuoteToken returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getQuoteTokenRule()); }
	iv_ruleQuoteToken=ruleQuoteToken
	{ $current=$iv_ruleQuoteToken.current; }
	EOF;

// Rule QuoteToken
ruleQuoteToken returns [EObject current=null]
@init {
	enterRule();
}
@after {
			...
			(
				(
					...
					}
					{
					    ...
					    |
					lv_content_1_2=RULE_INTERPOLATE
					{
